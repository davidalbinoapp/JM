...
**cima / baixo / centro** (corte vertical). O motor respeita o `FOCO:` e ignora
o automático só naquela foto. Um valor que não faz sentido pro corte daquela
foto (ex.: `cima` numa foto que só corta as laterais) é ignorado sem quebrar.
