...
rem ===========================================================================
rem  Montar JM (Windows) — roda o Jornal Mural com 2 cliques, SEM digitar
rem  caminho nenhum. Equivalente ao "Montar JM.command" do Mac.
rem
rem  Como usar:
rem    1) Coloque TODAS as fotos e QR da semana dentro da pasta da semana.
rem    2) De dois cliques neste arquivo ("Montar JM (Windows).bat").
