#!/bin/bash
# ---------------------------------------------------------------------------
#  Criar atalho (Mac) — gera o "Montar JM.app": um aplicativo bonito, com
#  ícone da marca, pra rodar o Jornal Mural com um clique.
#
#  Rode UMA VEZ por Mac (dois cliques neste arquivo). Ele cria o
#  "Montar JM.app" na pasta "JM SYSTEM" (ao lado da JM-main), com cara de app.
...
echo "Criando o Montar JM.app em: $BASE"
...
on run
    ...
    if cmdPath is "" then
        ...
        set cmdPath to jm & "Montar JM.command"
    end if
...
on acharLauncher()
    ...
    set cands to {appParent & "/JM-main/Montar JM.command", appParent & "/JM SYSTEM/JM-main/Montar JM.command", lar & "Documents/Artes/AGA/2026/JM SYSTEM/JM-main/Montar JM.command"}
...
echo "Arraste o 'Montar JM.app' pro Dock ou pra Área de Trabalho e use com 1 clique."
echo
[ "$AUTO" = "1" ] || read -n 1 -s -r -p "Aperte qualquer tecla pra fechar..."
[ "$AUTO" = "1" ] || echo
