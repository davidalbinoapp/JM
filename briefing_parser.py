...
def parse_briefing(docx_path):
    ...
    for text, is_bold in linhas:
        ...
        if m_foto and materia_atual is not None:
            ...
            # captura o CONTEÚDO inteiro do(s) marcador(es) de foco. Assim um
            # foco 2D "(foco: direita 30% baixo 20%)" preserva os DOIS eixos (o
            # motor extrai cada eixo). Junta o conteúdo de todos os marcadores
            # (o usuário pode escrever "(foco: direita 30%) (foco: baixo 20%)")
            # e remove todos da linha — nada sobra grudado no nome do arquivo.
