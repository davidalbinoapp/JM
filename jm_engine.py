...
# do seu conteúdo — espelhando como o David resolve à mão (ver memória de
# diagramação/transbordo). O corpo ganha mais folga vertical (reservamos só o
...
_PT_HEADER_BOX = 18.0       # fonte do título da seção de boxes ("Período ...:"): 18pt
                            ...
                            # título). Valor validado pelo David na diagramação manual.
_CAL_CORPO_FLUXO = 1.0      # fator de calibração da altura do corpo p/ posicionar os
                            # boxes. 1.0 = respiro que o David aprovou (o estimador é
...
def _pt_do_box(placeholders, default=14.0):
    ...
    render) — é a medida compacta que reproduz o encaixe do David: caixas
...
def _fluxo_boxes_unica(slide, body_box, placeholders, linhas, boxes_ef, header_text,
    ...
    # negrito (mesmo tamanho das caixas, em bold = título), como o David faz à mão
    if header_text:
